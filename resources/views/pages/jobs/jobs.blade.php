...
<div class="container">
	<div class="col-md-12">
		...
		@endif
			<form class="d-none d-md-inline-block form-inline ms-auto  my-md-10" action ="{{ url('jobs') }}">
			...
			<div class="card-body">
					<table class="table">
					  ...
					  <tbody>
					    ...
					    <tr>
					      <th>{{ $jobdata->id }}</th>
					      <th>{{ $jobdata->job_code }}</th>
					      <th>{{ $jobdata->job_title }}</th>
					      <th><a href="{{ url('edit-job/'.$jobdata->id) }}" class="btn btn-primary">Edit</a></th>
					      <th><a href="{{ url('delete-job/'.$jobdata->id) }}" class="btn btn-danger">Delete</a></th>
					    </tr>
					  	@endforeach
